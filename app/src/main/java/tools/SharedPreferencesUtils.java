...
public class SharedPreferencesUtils {
    ...
    public void putValues(ContentValue... contentValues) {
        ...
        for (ContentValue contentValue : contentValues) {
            ...
            if(contentValue.value instanceof ArrayList){
                ArrayList<Task> connections = (ArrayList<Task>) contentValue.value;
                // convert java object to JSON format,
                // and returned as JSON formatted string
                String connectionsJSONString = new Gson().toJson(connections);
                editor.putString(contentValue.key, connectionsJSONString);
            }
            editor.commit();
        }
    }
    ...
    public ArrayList getArrayList(String key){
        String tasksJSONString = sharedPreferences.getString(key, null);
        Type type = new TypeToken< ArrayList < Task >>() {}.getType();
        ArrayList < Task > tasks = new Gson().fromJson(tasksJSONString, type);
        return tasks;
    }
